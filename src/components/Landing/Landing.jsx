      ...
      <section className="flex flex-row py-20 bg-white rounded-lg mx-4 mt-5 relative">
        <div className="bg-white p-8 rounded-lg max-w text-left">
          <h1 className="text-6xl font-bold text-gray-800 mb-4">
            Conduct Seamless, Secure Exams with Ease.
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-purple-600">User Guides</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Email Us</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Help Center</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 text-center text-gray-600">
            &copy; 2024 ExamNest. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
