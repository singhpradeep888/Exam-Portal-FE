...
const Examinees = () => {
  ...
  function readExcel(file, name) {
    ...
    reader.onload = (e) => {
      ...
      const examinees = utils.sheet_to_json(workbook.Sheets[workbook.SheetNames[0]]);
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-1 flex-col p-4 w-full h-screen gap-4">
        <h1 className="text-4xl font-bold text-gray-700 py-4 border-b">Add Examinees</h1>

        <div className="border rounded p-4 ">
          <div className="flex items-end gap-4">
            <div>
              <Input label="Upload Examinees sheet" type="file" name="examinees" onChange={handleData} />
            </div>
          ...
          <p className="mt-4 text-gray-400 italic text-xs">
            NOTE: Examinees email that doesn't have student account with us will be created.
          </p>
        </div>
